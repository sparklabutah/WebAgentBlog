...
We were originally planning to write a full survey paper with a collaborator as a way to get up to speed before we worked on a new project in the area (more on this soon I hope). Unfortunately, we got busy and we just got scooped. There are now quite a few papers on LLM Agents and more specifically Computer Use. This took a bit of the wind out of our sails, but we wanted to still talk about some of the stuff we learned and present it in an engaging way.
...
<iframe src="/webagentblog/assets/html/2026-04-27-web-agent/carousel.html" width="100%" height="520" frameborder="0" style="border-radius: 12px; margin: 1rem 0;"></iframe>
...
As you may notice we also here try to take advantage of the medium of the web specifically to make our survey a bit different and a bit more interactive for readers. Claude Sonnet 4 was used to help build this website. We hope you enjoy!
...
<iframe src="/webagentblog/assets/html/2026-04-27-web-agent/definitions.html" width="100%" height="480" frameborder="0" style="border-radius: 12px; margin: 1.5rem 0;"></iframe>
...
<iframe src="/webagentblog/assets/html/2026-04-27-web-agent/observatory.html" width="100%" height="750" frameborder="0" style="border-radius: 12px; margin: 1.5rem 0;"></iframe>
...
<iframe src="/webagentblog/assets/html/2026-04-27-web-agent/timemachine.html" width="100%" height="580" frameborder="0" style="border-radius: 12px; margin: 1.5rem 0;"></iframe>
...
{% include figure.liquid loading="eager" path="assets/img/2026-04-27-web-agent/FSMDiagram.png" class="img-fluid rounded z-depth-1" alt="LLM Agent Control Flow Diagram" caption="Typical control flow diagram for an LLM agent showing how control passes between differently prompted versions of the LLM/VLM and external components." %}
...
This survey was adapted from the original interactive web version created by anonymous authors. As the authors noted, they tried to take advantage of the medium of the web specifically to make their survey a bit different and a bit more interactive for readers. Claude Sonnet 4 was used to help build the original website. Special thanks to anonymous contributors who provided valuable feedback and helped debug browser compatibility issues.
